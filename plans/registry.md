...
| M012B | `implementation/python/012b-fixture-report-and-data-bindings.md` | implemented (hosted qualification pending) | M012A | fixture/report/data bindings |
...
`35953277189`. M012B is implemented and awaiting hosted qualification;
