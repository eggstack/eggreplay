...
| M012C | `implementation/python/012c-async-lifecycle-and-network-bindings.md` | ready | M012B | async/sync lifecycle + network operations |
...
run `35956198913`. M012C is the next ready plan; M012D–M012F and M013–M014D
