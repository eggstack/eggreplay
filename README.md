...
preflight is closed. EggServe has now published the required absolute-form
service seam in server 0.3.0/primitives 0.2.1. M013B0 is ready to adopt and
qualify that source-incompatible direct-runtime line before M013B proxy work
resumes. Interception is not yet part of the supported product baseline. M014
remains downstream of M013.
